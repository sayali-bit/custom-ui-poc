  ...
  return (
    <Tooltip title="Learn a reusable plan from this conversation and save it to your library!">
      <button
        ...
        className={`inline-flex items-center px-3 py-1.5 rounded-md transition-colors ${
          darkMode === "dark"
            ? "bg-blue-700 text-blue-400 border border-blue-400 hover:bg-blue-700 hover:border-blue-700"
            : "bg-blue-400 text-blue-800 border border-blue-200 hover:bg-blue-400 hover:border-blue-300"
        } ${
