        ...
        <div className="flex justify-between items-center mb-4 border-b flex-shrink-0">
          <div className="flex">
            <button
              className={`px-6 py-2 font-medium rounded-t-lg transition-colors ${
                activeTab === "screenshots"
                  ? "bg-blue-400 text-primary border-1 border-2 "
            ...
            <button
              className={`px-6 py-2 font-medium rounded-t-lg transition-colors ${
                activeTab === "live"
                  ? "bg-blue-400 text-primary border-2 border-b-0 border-primary"
                  : "text-secondary hover:text-primary hover:bg-secondary/10"
              }`}
          ...
          <div className="flex gap-2">
            {isControlMode && (
              <div className="flex items-center gap-2 px-2 rounded-2xl bg-blue-800 text-white">
